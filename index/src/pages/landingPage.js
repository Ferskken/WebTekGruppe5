    ...
    render() {
      ...
      <div>
          <nav>
              <div className="navbar">
                  <div className="container nav-container">
                      ...
                      <div className="logo">
                          <h1><img src="pictures/rk.jpg"  alt={"rodeKors"}/></h1>
                      </div>
          ...
          <main className="center">
              ...
              <div id="secondHeader">
                  <img src="pictures/rk2.png" id="landingPagePic"  alt={"rodeKors2"}/>
              </div>
              ...
              <div className="offerRow">
                  ...
                  <article className="articles">
                      <div className="offerColumn">
                          <div className="article_image">
                              <img className="offerPics" src="/pictures/flyktningsvenn.jpg"  alt={"flyktningsvenn"}/>
                          </div>
                  ...
                  <article className="articles">
                      <div className="offerColumn">
                          <div className="article_image">
                              <img className="offerPics" src="pictures/besoeksvenn.jpg"  alt={"besoksvenn"}/>
                          </div>
                          <div className="article_text">
                              <div className="article_intro">
                                  <h3>Besøksvenn!</h3>
                  ...
                  <article className="articles">
                      <div className="offerColumn">
                          <div className="article_image">
                              <img className="offerPics" src="pictures/RKungdom.jpg"  alt={"Rkungdom"}/>
                          </div>
                          <div className="article_text">
                              <div className="article_intro">
 ...
 *                     <br />
 *
 *                     <a className="links1" href="products.html" >Les mer!</a></br>
 *                 </div>
 *               </div>
 *             </div>
 *           </article>
 ...
 *                       <br>
 *
 *                         <a className="links1" href="products.html">Les mer!</a></br></br></br>
 *
 *                 </div>
 *               </div>
 *             </div>
